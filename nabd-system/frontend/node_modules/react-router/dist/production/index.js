...
function ServerRouter({
  ...
  let routes = _chunkHUBUW7R3js.createServerRoutes.call(void 0, 
    manifest.routes,
    routeModules,
    context.future,
    context.isSpaMode
  ...
  for (let match of context.staticHandlerContext.matches) {
    ...
    if (route && manifestRoute && _chunkHUBUW7R3js.shouldHydrateRouteLoader.call(void 0, 
      routeId,
      route.clientLoader,
  ...
  let router = _chunkPNZCCTKTjs.createStaticRouter.call(void 0, routes, context.staticHandlerContext, {
    branches: context.branches
  });
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    _chunkHUBUW7R3js.FrameworkContext.Provider,
    {
      value: {
        manifest,
        routeModules,
    ...
    /* @__PURE__ */ React.createElement(_chunkHUBUW7R3js.RemixErrorBoundary, { location: router.state.location }, /* @__PURE__ */ React.createElement(
      _chunkPNZCCTKTjs.StaticRouterProvider,
      {
        router,
    ...
    _chunkHUBUW7R3js.StreamTransfer,
    {
      context,
      identifier: 0,
  ...
  return function RoutesTestStub({
    ...
    if (routerRef.current == null) {
      ...
      let patched = processRoutes(
        ...
        _chunkHUBUW7R3js.convertRoutesToDataRoutes.call(void 0, routes, (r) => r),
        _context !== void 0 ? _context : _optionalChain([future, 'optionalAccess', _5 => _5.v8_middleware]) ? new (0, _chunkHUBUW7R3js.RouterContextProvider)() : {},
        frameworkContextRef.current.manifest,
        frameworkContextRef.current.routeModules
      );
      routerRef.current = _chunkHUBUW7R3js.createMemoryRouter.call(void 0, patched, {
        initialEntries,
        initialIndex,
        hydrationData
      });
    }
    return /* @__PURE__ */ React2.createElement(_chunkHUBUW7R3js.FrameworkContext.Provider, { value: frameworkContextRef.current }, /* @__PURE__ */ React2.createElement(_chunkHUBUW7R3js.RouterProvider, { router: routerRef.current }));
  };
}
function processRoutes(routes, context, manifest, routeModules, parentId) {
  return routes.map((route) => {
    ...
    let newRoute = {
      ...
      path: route.path,
      index: route.index,
      Component: route.Component ? _chunkHUBUW7R3js.withComponentProps.call(void 0, route.Component) : void 0,
      HydrateFallback: route.HydrateFallback ? _chunkHUBUW7R3js.withHydrateFallbackProps.call(void 0, route.HydrateFallback) : void 0,
      ErrorBoundary: route.ErrorBoundary ? _chunkHUBUW7R3js.withErrorBoundaryProps.call(void 0, route.ErrorBoundary) : void 0,
    ...
    routeModules[route.id] = {
      default: newRoute.Component || _chunkHUBUW7R3js.Outlet,
...
function warnOnceAboutExpiresCookie(name, expires) {
  _chunkHUBUW7R3js.warnOnce.call(void 0, 
    !expires,
...
function matchServerRoutes(manifest, dataRoutes, branches, pathname, basename) {
  let matches = _chunkHUBUW7R3js.matchRoutesImpl.call(void 0, 
    dataRoutes,
    pathname,
...
async function callRouteHandler(handler, args, future) {
  ...
  if (_chunkHUBUW7R3js.isDataWithResponseInit.call(void 0, result) && result.init && result.init.status && _chunkHUBUW7R3js.isRedirectStatusCode.call(void 0, result.init.status)) {
    ...
    let commonRoute = {
      ...
      loader: route.module.loader ? async (args) => {
        ...
        if (preRenderedData != null) {
          ...
          let decoded = await _chunkHUBUW7R3js.decodeViaTurboStream.call(void 0, stream, global);
          let data2 = decoded.value;
          if (data2 && _chunkHUBUW7R3js.SingleFetchRedirectSymbol in data2) {
            let result = data2[_chunkHUBUW7R3js.SingleFetchRedirectSymbol];
            let init = { status: result.status };
            if (result.reload) {
              throw _chunkHUBUW7R3js.redirectDocument.call(void 0, result.redirect, init);
            } else if (result.replace) {
              throw _chunkHUBUW7R3js.replace.call(void 0, result.redirect, init);
            } else {
              throw _chunkHUBUW7R3js.redirect.call(void 0, result.redirect, init);
            }
          } else {
            invariant2(
...
function createServerHandoffString(serverHandoff) {
  return _chunkHUBUW7R3js.escapeHtml.call(void 0, JSON.stringify(serverHandoff));
}
...
function getNormalizedPath(request, basename, future) {
  ...
  if (_optionalChain([future, 'optionalAccess', _11 => _11.unstable_trailingSlashAwareDataRequests])) {
    ...
    if (_chunkHUBUW7R3js.stripBasename.call(void 0, pathname, basename) === "/_root.data") {
      pathname = basename;
    } else if (pathname.endsWith(".data")) {
      pathname = pathname.replace(/\.data$/, "");
    }
    if (_chunkHUBUW7R3js.stripBasename.call(void 0, pathname, basename) !== "/" && pathname.endsWith("/")) {
...
var SERVER_NO_BODY_STATUS_CODES = /* @__PURE__ */ new Set([
  ..._chunkHUBUW7R3js.NO_BODY_STATUS_CODES,
  304
]);
async function singleFetchAction(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) {
  ...
  function handleQueryResult(result) {
    return _chunkHUBUW7R3js.isResponse.call(void 0, result) ? result : staticContextToResponse(result);
  }
  ...
  function staticContextToResponse(context) {
    ...
    if (_chunkHUBUW7R3js.isRedirectStatusCode.call(void 0, context.statusCode) && headers.has("Location")) {
      return new Response(null, { status: context.statusCode, headers });
    }
    if (context.errors) {
      Object.values(context.errors).forEach((err) => {
        if (!_chunkHUBUW7R3js.isRouteErrorResponse.call(void 0, err) || err.error) {
          handleError(err);
        }
      });
...
function generateSingleFetchRedirectResponse(redirectResponse, request, build, serverMode) {
  ...
  return generateSingleFetchResponse(request, build, serverMode, {
    result: request.method === "GET" ? { [_chunkHUBUW7R3js.SingleFetchRedirectSymbol]: redirect2 } : redirect2,
    headers,
    status: _chunkHUBUW7R3js.SINGLE_FETCH_REDIRECT_STATUS
  });
}
function getSingleFetchRedirect(status, headers, basename) {
  let redirect2 = headers.get("Location");
  if (basename) {
    redirect2 = _chunkHUBUW7R3js.stripBasename.call(void 0, redirect2, basename) || redirect2;
  }
  return {
    redirect: redirect2,
    status,
...
function encodeViaTurboStream(data2, requestSignal, streamTimeout, serverMode) {
  ...
  return _chunkHUBUW7R3js.encode.call(void 0, data2, {
    ...
    plugins: [
      (value) => {
        ...
        if (value instanceof _chunkHUBUW7R3js.ErrorResponseImpl) {
          let { data: data3, status, statusText } = value;
          return ["ErrorResponse", data3, status, statusText];
        }
        if (value && typeof value === "object" && _chunkHUBUW7R3js.SingleFetchRedirectSymbol in value) {
          return ["SingleFetchRedirect", value[_chunkHUBUW7R3js.SingleFetchRedirectSymbol]];
        }
      }
    ],
    postPlugins: [
...
function derive(build, mode) {
  ...
  let staticHandler = _chunkHUBUW7R3js.createStaticHandler.call(void 0, dataRoutes, {
  ...
  let errorHandler = build.entry.module.handleError || ((error, { request }) => {
    if (serverMode !== "test" /* Test */ && !request.signal.aborted) {
      console.error(
        ...
        _chunkHUBUW7R3js.isRouteErrorResponse.call(void 0, error) && error.error ? error.error : error
      );
    }
  });
  let requestHandler = async (request, initialContext) => {
    ...
    if (build.future.v8_middleware) {
      if (initialContext && !(initialContext instanceof _chunkHUBUW7R3js.RouterContextProvider)) {
        let error = new Error(
      ...
      loadContext = initialContext || new (0, _chunkHUBUW7R3js.RouterContextProvider)();
    } else {
    ...
    if (!build.ssr) {
      ...
      if (build.basename && build.basename !== "/") {
        let strippedPath = _chunkHUBUW7R3js.stripBasename.call(void 0, decodedPath, build.basename);
        if (strippedPath == null) {
          errorHandler(
            new (0, _chunkHUBUW7R3js.ErrorResponseImpl)(
              404,
              "Not Found",
    ...
    let manifestUrl = _chunkHUBUW7R3js.getManifestPath.call(void 0, 
    ...
    if (requestUrl.pathname.endsWith(".data")) {
      ...
      if (_chunkHUBUW7R3js.isRedirectResponse.call(void 0, response)) {
  ...
  if (build.entry.module.instrumentations) {
    requestHandler = _chunkHUBUW7R3js.instrumentHandler.call(void 0, 
      requestHandler,
...
async function handleSingleFetchRequest(serverMode, build, staticHandler, request, normalizedPath, loadContext, handleError) {
  ...
  let response = _chunkHUBUW7R3js.isMutationMethod.call(void 0, request.method) ? await singleFetchAction(
    build,
    serverMode,
    staticHandler,
    request,
...
async function handleDocumentRequest(serverMode, build, staticHandler, request, loadContext, handleError, isSpaMode, criticalCss) {
  try {
    if (_chunkHUBUW7R3js.isMutationMethod.call(void 0, request.method)) {
      try {
        throwIfPotentialCSRFAttack(
          request.headers,
          Array.isArray(build.allowedActionOrigins) ? build.allowedActionOrigins : []
    ...
    let result = await staticHandler.query(request, {
      ...
      generateMiddlewareResponse: build.future.v8_middleware ? async (query) => {
        try {
          ...
          if (!_chunkHUBUW7R3js.isResponse.call(void 0, innerResult)) {
    ...
    if (!_chunkHUBUW7R3js.isResponse.call(void 0, result)) {
  ...
  async function renderHtml(context, isSpaMode2) {
    ...
    try {
      ...
      if (_chunkHUBUW7R3js.isResponse.call(void 0, error)) {
        try {
          let data2 = await unwrapResponse(error);
          errorForSecondRender = new (0, _chunkHUBUW7R3js.ErrorResponseImpl)(
            error.status,
            error.statusText,
            data2
          );
      ...
      context = _chunkHUBUW7R3js.getStaticContextFromError.call(void 0, 
        staticHandler.dataRoutes,
        context,
...
async function routeRSCServerRequest({
  ...
  try {
    ...
    if (serverResponse.status === _chunkHUBUW7R3js.SINGLE_FETCH_REDIRECT_STATUS && payload.type === "redirect") {
    ...
    let html = await renderHTML(getPayload, {
      onError(error) {
        if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
          renderRedirect = _chunkHUBUW7R3js.decodeRedirectErrorDigest.call(void 0, error.digest);
          if (renderRedirect) {
            return error.digest;
          }
          let routeErrorResponse = _chunkHUBUW7R3js.decodeRouteErrorResponseDigest.call(void 0, error.digest);
        ...
        if (renderRedirect) {
          controller.enqueue(
            new TextEncoder().encode(
              `<meta http-equiv="refresh" content="0;url=${_chunkHUBUW7R3js.escapeHtml.call(void 0, renderRedirect.location)}"/>`
            )
          );
        }
      }
    ...
    try {
      ...
      let [status, statusText] = _chunkHUBUW7R3js.isRouteErrorResponse.call(void 0, normalizedError) ? [normalizedError.status, normalizedError.statusText] : [500, ""];
      let retryRedirect;
      let reactHeaders = new Headers();
        ...
        },
        {
          onError(error2) {
            if (typeof error2 === "object" && error2 && "digest" in error2 && typeof error2.digest === "string") {
              retryRedirect = _chunkHUBUW7R3js.decodeRedirectErrorDigest.call(void 0, error2.digest);
              if (retryRedirect) {
                return error2.digest;
              }
              let routeErrorResponse = _chunkHUBUW7R3js.decodeRouteErrorResponseDigest.call(void 0, 
                error2.digest
              );
              if (routeErrorResponse) {
                status = routeErrorResponse.status;
      ...
      const retryRedirectTransform = new TransformStream({
        flush(controller) {
          if (retryRedirect) {
            controller.enqueue(
              new TextEncoder().encode(
                `<meta http-equiv="refresh" content="0;url=${_chunkHUBUW7R3js.escapeHtml.call(void 0, retryRedirect.location)}"/>`
              )
            );
          }
        }
...
function RSCStaticRouter({ getPayload }) {
  ...
  const router = _chunkPNZCCTKTjs.createStaticRouter.call(void 0, 
  ...
  const frameworkContext = {
    ...
    routeModules: _chunkY6IFXO7Vjs.createRSCRouteModules.call(void 0, payload)
  };
  return /* @__PURE__ */ React3.createElement(_chunkHUBUW7R3js.RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3.createElement(_chunkY6IFXO7Vjs.RSCRouterGlobalErrorBoundary, { location: payload.location }, /* @__PURE__ */ React3.createElement(_chunkHUBUW7R3js.FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3.createElement(
    _chunkPNZCCTKTjs.StaticRouterProvider,
    {
      context,
      router,
